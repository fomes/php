<?php
    ...
    //testa se ja existe usuario logado
     if(isset($_SESSION[md5('user_data')])){      
        ...
        //var_dump($user);
        //echo $user->profile_page;
        header("location: ".$user->perfil_pagina);
  }
...
<head>
  ...
  <title>Area de Login - Consultas Power | Administração </title>
  ...
  <style type="text/css">
    body {
      background: url('https://www.kigpapeldeparede.com.br/wp-content/uploads/2017/07/New_York_City_at_night_HDR-1.jpg') !important;
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="http://a4dev.com.br" target="_blank" class="text-center">Powered by Anthony Jefferson UTD &copy;</a>
    <!-- esqueci minha senha -->
