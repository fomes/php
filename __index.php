...
<head>
  ...
  <title>Prefeitura Municipal de <?=$config['config_city'];?> | Administração </title>
  ...
  <style type="text/css">
    body {
      background: url('upload/<?=$config["config_bannermenu"];?>') !important;
...
<div class="login-box">
  <div class="login-logo">
  	<img src="upload/<?=$config['config_logo'];?>" alt="logo" height="80" width="220">
  ...
  <div class="login-box-body">
    ...
    <a href="http://a4dev.com.br" target="_blank" class="text-center">Powered by FMF Desenvolvimento &copy;</a>
    <!-- esqueci minha senha -->
